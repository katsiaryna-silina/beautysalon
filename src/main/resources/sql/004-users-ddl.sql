...
(
    ...
    DISCOUNT_STATUS_ID INT UNSIGNED NOT NULL DEFAULT 1,
...
CREATE UNIQUE INDEX IDX_UN_USERS_USER_NAME ON SALON.USERS (USERNAME);
CREATE UNIQUE INDEX IDX_UN_USERS_EMAIL ON SALON.USERS (EMAIL);
