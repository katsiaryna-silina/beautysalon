...
<div class="container">
    ...
    <br/>
    <h6><fmt:message key="user.info"/></h6>
    <a><fmt:message key="user.username"/> ${order.getUsername()},
        <fmt:message key="user.first.name"/> ${order.getFirstName()},
        <fmt:message key="user.last.name"/> ${order.getLastName()}</a>
    <br/>
    <a><fmt:message key="user.email"/> ${order.getEmail()},
        <fmt:message key="user.phone.number"/> ${order.getPhoneNumber()}
    </a>
    <br/>
    <hr/>
